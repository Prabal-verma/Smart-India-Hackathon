  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center py-8 px-4">
      ...
      <section className="text-center mb-12 px-4 md:px-6 lg:px-8">
        <h1 className="text-4xl md:text-5xl font-extrabold text-text mb-4">Welcome to the Contract Farming Platform</h1>
        ...
        <a href="/get-started" className="bg-primary text-white py-3 px-6 rounded-lg shadow-lg hover:bg-secondary transition-colors duration-300">
          Get Started
        </a>
      </section>
